      ...
      <footer class="bg-ink border-t rule-dark">
        <div class="max-w-6xl mx-auto px-6 lg:px-10 py-12">
          ...
          <div class="border-t rule-dark pt-8 grid md:grid-cols-2 gap-6">
            <p class="text-xs leading-relaxed" style="color:rgba(242,234,216,.45)">
            ...
            <address class="text-xs not-italic md:text-right" style="color:rgba(242,234,216,.45)">
              30 N Gould St, Ste N<br />
              Sheridan, WY 82801<br />
              <a href="mailto:info@fullstacklending.com" class="text-cream/45 hover:text-cream transition-colors duration-200">info@fullstacklending.com</a>
            </address>
          </div>
        </div>
      </footer>
